...
namespace Aural_Probe
{
	public class PersistWindowState : System.ComponentModel.Component
	{
		...
		public PersistWindowState(MainForm mainForm)
		{
			mMainForm = mainForm;
		}
		...
		private void OnClosing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			...
			key.SetValue("Volume", mMainForm.trackBarMasterVol.Value);
		...
		private void OnLoad(object sender, System.EventArgs e)
		{
			...
			if(key != null)
			{
				...
				mMainForm.trackBarMasterVol.Value = (int)key.GetValue("Volume", 100);
